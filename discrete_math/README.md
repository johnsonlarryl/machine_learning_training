...
This project is a practical training tutorial for learning about the various Discrete Mathematics algorithms using the matplotlib, NumPy, pandas, scikit-learn, SciPy, and seaborn python modules.
...
```sh
poetry run jupyter notebook discrete_math
```
